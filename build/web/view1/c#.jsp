...
<html lang="en">
    ...
    <body onload="checkLogin()" style="  background-image:url(http://localhost:8084/Project/Icon/1.jpg);background-size: 100%;">
        <article>
            ...
            <div id="pro1">
                <a  href="http://localhost:8084/Project/view1/java.html"> <img src="http://localhost:8084/Project/images/java1.jpeg" id="img24" style="margin:10px;width:290px;height:100px;"  id="s1"></a>            
                ...
                <a href="http://localhost:8084/Project/view1/payment.jsp"> <input type="button" value="$65"/></a>

            </div>
            <div id="pro2">
                <a  href="http://localhost:8084/Project/view/css.html"> <img src="http://localhost:8084/Project/images/java2.png" id="img24" style="margin:10px;width:290px;height:100px;"  id="s2">
                ...
                <a href="http://localhost:8084/Project/view1/payment.jsp"><input type="button" value="$30"/></a>
            </div>
            <div id="pro3">
                <a  href="http://localhost:8084/Project/view/css.html"> <img src="http://localhost:8084/Project/images/java3.jpg" id="img24" style="margin:10px;width:290px;height:100px;"  id="s3">
            ...
            <div id="pro4">
                <a  href="http://localhost:8084/Project/view/css.html"> <img src="http://localhost:8084/Project/images/java4.jpg" id="img24"  style="margin:10px;width:290px;height:100px;"  >
            ...
            <div id="pro5">
                <a  href="http://localhost:8084/Project/view/css.html"> <img src="http://localhost:8084/Project/images/java5.png" id="img24"  style="margin:10px;width:290px;height:100px;" id="s5">
            ...
            <div id="pro6">
                <a  href="http://localhost:8084/Project/view/css.html"> <img src="http://localhost:8084/Project/images/java6.jpg"  id="img24" style="margin:10px;width:290px;height:100px;" id="s6">
