...
<html lang="en">
    ...
    <body onload="checkLogin()" style="  background-image:url(http://localhost:8084/Project/Icon/1.jpg);background-size: 100%;">
        <article>
            ...
            <div id="iddiv1">
                <h2 style="font-size: 40px ;color: rgb(96, 189, 21);margin-left:250px">Math </h2>
            </div>
            ...
            <div id="pro2">
                ...
                <a href="http://localhost:8084/Project/view/payment_page.jsp"><input type="button" value="$30"/></a>
            </div>
            <div id="pro3">
            ...
            <div id="pro4">
                ...
                <a href="http://localhost:8084/Project/view/payment_page.jsp"><input type="button" value="$55"/></a>
            </div>
            <div id="pro5">
                ...
                <a href="http://localhost:8084/Project/view/payment_page.jsp"><input type="button" value="$52"/></a>
            </div>
            <div id="pro6">
                ...
                <a href="http://localhost:8084/Project/view/payment_page.jsp"> <input type="button" value="$50"/></a>
            </div>
            <div id="iddiv2">
