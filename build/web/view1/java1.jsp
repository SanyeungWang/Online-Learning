...
<html lang="en">
    ...
    <body onload="checkLogin()" style="  background-image:url(http://localhost:8084/Project/Icon/1.jpg);background-size: 100% 100%;">
        <article>
            ...
            <div id="iddiv1">
                <h2 style="font-size: 40px ;color: rgb(96, 189, 21);margin-left:250px">Java </h2>
            </div>
            <h1 style="margin-left:250px">English courses</h1>
            <div id="pro1">
                <a  href="http://localhost:8084/Project/view1/java.html"> <img src="http://localhost:8084/Project/images/Java/1.jpg" id="img24" style="margin:10px;width:290px;height:100px;"  id="s1"></a>            
                ...
                <a href="http://localhost:8084/Project/view/payment1.jsp?course=Java Core Technology&price=65"> <input type="button" value="$65"/></a>

            </div>
            <div id="pro2">
                <a  href="http://localhost:8084/Project/view1/java.html"><img src="http://localhost:8084/Project/images/Java/2.png" id="img24" style="margin:10px;width:290px;height:100px;"  id="s2"></a>
                ...
                <p style="margin:10px">Java is welcomed for its excellent simplicity, versatility, and security...</p>
                 <a href="http://localhost:8084/Project/view/payment1.jsp?course=Java Core Technology&price=30"><input type="button" value="$30"/></a>
            </div>
            <div id="pro3">
                <a  href="http://localhost:8084/Project/view1/java.html"><img src="http://localhost:8084/Project/images/Java/3.jpg" id="img24" style="margin:10px;width:290px;height:100px;"  id="s3"></a>
                ...
                <p style="margin:10px">The goal is Java development capabilities.....</p>
                 <a href="http://localhost:8084/Project/view/payment1.jsp?course=Java Core Technology&price=45"><input type="button" value="$45"/></a>
            </div>


            <h2 style="margin-left:250px;margin-top:325px">Chinese Courses</h2>
            <div id="pro4">
                <a  href="http://localhost:8084/Project/view1/java.html"> <img src="http://localhost:8084/Project/images/Java/4.png" id="img24"  style="margin:10px;width:290px;height:100px;"  ></a>
                ...
                <p style="margin-left:10px;margin-top:-10px">java以卓越的简洁性，卓越行，可移植性和安全性受到欢迎....
                 ...
                 <a href="http://localhost:8084/Project/view/payment1.jsp?course=Java Core Technology&price=55"><input type="button" value="$55"/></a>
            </div>
            <div id="pro5">
                <a  href="http://localhost:8084/Project/view1/java.html"> <img src="http://localhost:8084/Project/images/Java/5.jpg" id="img24"  style="margin:10px;width:290px;height:100px;" id="s5"></a>
                ...
                <p style="margin-left:10px;margin-top:-10px">讲授Java编程知识同时，培养计算和创新思维，学习和实践并行....</p>
                 <a href="http://localhost:8084/Project/view/payment1.jsp?course=Java Core Technology&price=52"><input type="button" value="$52"/></a>
            </div>
            <div id="pro6">
                <a  href="http://localhost:8084/Project/view1/java.html"> <img src="http://localhost:8084/Project/images/Java/6.png"  id="img24" style="margin:10px;width:290px;height:100px;" id="s6"></a>
                ...
                <p style="margin-left:10px;margin-top:-5px">Java被广泛应用到企业级系统，手机，桌面系统等技术，是市场最急需的技术... </p>
                 <a href="http://localhost:8084/Project/view/payment1.jsp?course=Java Core Technology&price=50"> <input type="button" value="$50"/></a>
            </div>
            <div id="iddiv2">
