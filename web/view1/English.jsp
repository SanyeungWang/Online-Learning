...
<html lang="en">
    ...
    <body onload="checkLogin()" style="  background-image:url(http://localhost:8084/Project/Icon/1.jpg);background-size: 100%;">
        <article>
            ...
            <div id="iddiv1">
                <h2 style="font-size: 40px ;color: rgb(96, 189, 21);margin-left:250px">English</h2>
            </div>
            <h1 style="margin-left:250px">English courses</h1>
            <div id="pro1">
                <a  href="http://localhost:8084/Project/view/java.html"> <img src="http://localhost:8084/Project/images/English/A.jpg" id="img24" style="margin:10px;width:290px;height:100px;"  id="s1"></a>            
                <figcaption style="margin-top:-20px;margin-left:60px"><h4>English Core Technology</h4></figcaption>
                <p style="margin:10px">  English is not only a programming language, but also a huge ecosystem....... </p>
                <a href="http://localhost:8084/Project/view/payment.jsp"> <input type="button" value="$65"/></a>

            </div>
            <div id="pro2">
                <img src="http://localhost:8084/Project/images/English/D.jpg" id="img24" style="margin:10px;width:290px;height:100px;"  id="s2">
                <figcaption style="margin-top:-20px;margin-left:60px"><h4>English programming</h4></figcaption>
                <p style="margin:10px">English is welcomed for its excellent simplicity, versatility, and security...</p>
                <a href="http://localhost:8084/Project/view/payment.jsp"><input type="button" value="$30"/></a>
            </div>
            <div id="pro3">
                <img src="http://localhost:8084/Project/images/English/E.jpg" id="img24" style="margin:10px;width:290px;height:100px;"  id="s3">
                <figcaption style="margin-top:-20px;margin-left:60px"><h4>English Application Development Foundation</h4></figcaption>
                <p style="margin:10px">The goal is English development capabilities.....</p>
                <a href="http://localhost:8084/Project/view/payment.jsp"><input type="button" value="$45"/></a>
            </div>


            <h2 style="margin-left:250px;margin-top:325px">Chinese Courses</h2>
            <div id="pro4">
                <img src="http://localhost:8084/Project/images/English/B.jpg" id="img24"  style="margin:10px;width:290px;height:100px;"  >
                <figcaption style="margin-top:-35px;margin-left:120px"><h4>英语程序设计</h4></figcaption>
                <p style="margin-left:10px;margin-top:-10px">英语以卓越的简洁性，卓越行，可移植性和安全性受到欢迎....
                </p>
                <a href="http://localhost:8084/Project/view/payment.jsp"><input type="button" value="$55"/></a>
            </div>
            <div id="pro5">
                <img src="http://localhost:8084/Project/images/English/C.jpg" id="img24"  style="margin:10px;width:290px;height:100px;" id="s5">
                <figcaption style="margin-top:-35px;margin-left:90px"><h4>英语面向对象的程序设计</h4></figcaption>
                <p style="margin-left:10px;margin-top:-10px">讲授英语编程知识同时，培养计算和创新思维，学习和实践并行....</p>
                <a href="http://localhost:8084/Project/view/payment.jsp"><input type="button" value="$52"/></a>
            </div>
            <div id="pro6">
                <img src="http://localhost:8084/Project/images/English/F.jpg"  id="img24" style="margin:10px;width:290px;height:100px;" id="s6">
                <figcaption style="margin-top:-35px;margin-left:120px"><h4>英语核心技术</h4></figcaption>
                <p style="margin-left:10px;margin-top:-5px">英语被广泛应用到企业级系统，手机，桌面系统等技术，是市场最急需的技术... </p>
            ...
            <a href="http://localhost:8084/Project/view/Chemistry.jsp" target="_Blank"><img id="img24"src="http://localhost:8084/Project/images/Python/A.jpg"  style="height:260px;width:300px;margin-left:880px;margin-top:-25px;position:absolute;border-radius:30px;"></a>
        </article>
    </body>
</html>