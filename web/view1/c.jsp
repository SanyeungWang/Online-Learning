...
<html lang="en">
    ...
    <body onload="checkLogin()" style="  background-image:url(http://localhost:8084/Project/Icon/1.jpg);background-size: 100% 100%;">
        <article>
            <div id="div1">
            ...
            <div id="iddiv1">
                <h2 style="font-size: 40px ;color: rgb(96, 189, 21);margin-left:250px"> C Language </h2>
            </div>
            <h1 style="margin-left:250px">English courses</h1>
            <div id="pro1">
                <a  href="http://localhost:8084/Project/view/c.html"> <img src="http://localhost:8084/Project/images/C/C.jpg" id="img24" style="margin:10px;width:290px;height:100px;"  id="s1"></a>            
                <figcaption style="margin-top:-20px;margin-left:60px"><h4>C Core Technology</h4></figcaption>
                <p style="margin:10px">  C is not only a programming language, but also a huge ecosystem....... </p>
                 <a href="http://localhost:8084/Project/view/payment.jsp?course= C Core Technology&price=65"> <input type="button" value="$65"/></a>

            </div>
            <div id="pro2">
                 <a  href="http://localhost:8084/Project/view/c.html"><img src="http://localhost:8084/Project/images/C/E.png" id="img24" style="margin:10px;width:290px;height:100px;"  id="s2"></a>  
                <figcaption style="margin-top:-20px;margin-left:60px"><h4>C programming</h4></figcaption>
                <p style="margin:10px">C is welcomed for its excellent simplicity, versatility, and security...</p>
                 <a href="http://localhost:8084/Project/view/payment.jsp?course= C Core Technology&price=30"><input type="button" value="$30"/></a>
            </div>
            <div id="pro3">
                 <a  href="http://localhost:8084/Project/view/c.html"><img src="http://localhost:8084/Project/images/C/F.png" id="img24" style="margin:10px;width:290px;height:100px;"  id="s3"></a>  
                <figcaption style="margin-top:-20px;margin-left:60px"><h4>C Application Development Foundation</h4></figcaption>
                <p style="margin:10px">The goal is C development capabilities.....</p>
                 <a href="http://localhost:8084/Project/view/payment.jsp?course= C Core Technology&price=45"><input type="button" value="$45"/></a>
            </div>


            <h2 style="margin-left:250px;margin-top:325px">Chinese Courses</h2>
            <div id="pro4">
                <a  href="http://localhost:8084/Project/view/c.html"> <img src="http://localhost:8084/Project/images/C/A.jpg" id="img24"  style="margin:10px;width:290px;height:100px;"  ></a>  
                <figcaption style="margin-top:-35px;margin-left:120px"><h4>C程序设计</h4></figcaption>
                <p style="margin-left:10px;margin-top:-10px">java以卓越的简洁性，卓越行，可移植性和安全性受到欢迎....
                </p>
                 <a href="http://localhost:8084/Project/view/payment.jsp?course= C Core Technology&price=55"><input type="button" value="$55"/></a>
            </div>
            <div id="pro5">
                 <a  href="http://localhost:8084/Project/view/c.html"><img src="http://localhost:8084/Project/images/C/B.jpg" id="img24"  style="margin:10px;width:290px;height:100px;" id="s5"></a>  
                <figcaption style="margin-top:-35px;margin-left:90px"><h4>C 面向对象的程序设计</h4></figcaption>
                <p style="margin-left:10px;margin-top:-10px">讲授C编程知识同时，培养计算和创新思维，学习和实践并行....</p>
                 <a href="http://localhost:8084/Project/view/payment.jsp?course= C Core Technology&price=52"><input type="button" value="$52"/></a>
            </div>
            <div id="pro6">
                <a  href="http://localhost:8084/Project/view/c.html"> <img src="http://localhost:8084/Project/images/C/D.jpg"  id="img24" style="margin:10px;width:290px;height:100px;" id="s6"></a>  
                <figcaption style="margin-top:-35px;margin-left:120px"><h4>c语言核心技术</h4></figcaption>
                <p style="margin-left:10px;margin-top:-5px">C 被广泛应用到企业级系统，手机，桌面系统等技术，是市场最急需的技术... </p>
                 <a href="http://localhost:8084/Project/view/payment.jsp?course= C Core Technology&price=50"> <input type="button" value="$50"/></a>
            </div>
            <div id="iddiv2">
