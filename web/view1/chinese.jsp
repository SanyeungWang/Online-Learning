...
<html lang="en">
    ...
    <body onload="checkLogin()" style="  background-image:url(http://localhost:8084/Project/Icon/1.jpg);background-size: 100%;">
        <article>
            ...
            <div id="iddiv1">
                <h2 style="font-size: 40px ;color: rgb(96, 189, 21);margin-left:250px">Chinese </h2>
            </div>
            <h1 style="margin-left:250px">English courses</h1>
            <div id="pro1">
                <a  href="http://localhost:8084/Project/view/java.html"> <img src="http://localhost:8084/Project/images/Chinese/F.jpg" id="img24" style="margin:10px;width:290px;height:100px;"  id="s1"></a>            
                <figcaption style="margin-top:-20px;margin-left:60px"><h4>Chinese Core Technology</h4></figcaption>
                <p style="margin:10px">  Chinese is not only a programming language, but also a huge ecosystem....... </p>
                <a href="http://localhost:8084/Project/view/payment.jsp"> <input type="button" value="$65"/></a>

            </div>
            <div id="pro2">
                <img src="http://localhost:8084/Project/images/Chinese/B.png" id="img24" style="margin:10px;width:290px;height:100px;"  id="s2">
                <figcaption style="margin-top:-20px;margin-left:60px"><h4>Chinese programming</h4></figcaption>
                <p style="margin:10px">Chinese is welcomed for its excellent simplicity, versatility, and security...</p>
                <a href="http://localhost:8084/Project/view/payment.jsp"><input type="button" value="$30"/></a>
            </div>
            <div id="pro3">
                <img src="http://localhost:8084/Project/images/Chinese/D.jpg" id="img24" style="margin:10px;width:290px;height:100px;"  id="s3">
                <figcaption style="margin-top:-20px;margin-left:60px"><h4>Chinese Application Development Foundation</h4></figcaption>
                <p style="margin:10px">The goal is Chinese development capabilities.....</p>
            ...
            <div id="pro4">
                <img src="http://localhost:8084/Project/images/Chinese/C.jpg" id="img24"  style="margin:10px;width:290px;height:100px;"  >
                <figcaption style="margin-top:-35px;margin-left:120px"><h4>Chiese程序设计</h4></figcaption>
                <p style="margin-left:10px;margin-top:-10px">Chinese以卓越的简洁性，卓越行，可移植性和安全性受到欢迎....
                </p>
                <a href="http://localhost:8084/Project/view/payment.jsp"><input type="button" value="$55"/></a>
            </div>
            <div id="pro5">
                <img src="http://localhost:8084/Project/images/Chinese/A.png" id="img24"  style="margin:10px;width:290px;height:100px;" id="s5">
                <figcaption style="margin-top:-35px;margin-left:90px"><h4>Chinese面向对象的程序设计</h4></figcaption>
                <p style="margin-left:10px;margin-top:-10px">讲授Chinese编程知识同时，培养计算和创新思维，学习和实践并行....</p>
                <a href="http://localhost:8084/Project/view/payment.jsp"><input type="button" value="$52"/></a>
            </div>
            <div id="pro6">
                <img src="http://localhost:8084/Project/images/Chinese/E.jpg"  id="img24" style="margin:10px;width:290px;height:100px;" id="s6">
                <figcaption style="margin-top:-35px;margin-left:120px"><h4>Chinese核心技术</h4></figcaption>
                <p style="margin-left:10px;margin-top:-5px">Chinese被广泛应用到企业级系统，手机，桌面系统等技术，是市场最急需的技术... </p>
