...
<html>
    ...
    <body>
        ...
        <sql:query dataSource="${ds}" var="result">
            Select * From COURSES where CATEGORY = 'Java Language'
        </sql:query>
    <center>
        <h1>View Search Result</h1>
        <input type="button" width="100px" height="30px" background="blue" value="View All Courses" onclick="window.location.href = 'http://localhost:8084/Project/view/searchall.jsp';" >
    </center>
    <center>
